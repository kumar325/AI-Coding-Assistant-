...
class Plan(BaseModel):
    ...
    description: str = Field(
        description="The description of the app to be built, e.g. 'A web app for managing personal finances")
    techstack: str = Field(
    ...
    files: list[File] = Field(description="A list of file to be created, each with a 'path' and 'purpose'")
